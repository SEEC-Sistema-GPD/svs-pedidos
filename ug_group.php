...
$nonAdminTablesArr[] = "np";
$nonAdminTablesArr[] = "pedidos";
$nonAdminTablesArr[] = "cad_prod";
$nonAdminTablesArr[] = "fornecedores";
$nonAdminTablesArr[] = "escolas";
$nonAdminTablesArr[] = "exercicios";
$nonAdminTablesArr[] = "status";
$nonAdminTablesArr[] = "itens_view";
$nonAdminTablesArr[] = "pedidos_usuarios";
$nonAdminTablesArr[] = "un_med";
$nonAdminTablesArr[] = "pedidos_view";
$nonAdminTablesArr[] = "cidades";
$nonAdminTablesArr[] = "draes";
$nonAdminTablesArr[] = "tecnico";
$nonAdminTablesArr[] = "bairros";
$nonAdminTablesArr[] = "alternativa";
$nonAdminTablesArr[] = "itens";
$nonAdminTablesArr[] = "fornecedores_view";
$nonAdminTablesArr[] = "NP_escola";
$nonAdminTablesArr[] = "Pedidos_escola";
$nonAdminTablesArr[] = "itens_escola";
$nonAdminTablesArr[] = "funcao";
$nonAdminTablesArr[] = "direcs";
$nonAdminTablesArr[] = "Relatório Sintético de Escolas";
$nonAdminTablesArr[] = "Relatório Analítico de Escolas";
$nonAdminTablesArr[] = "pedidos3_noti";
$nonAdminTablesArr[] = "Consulta Gêneros";
$nonAdminTablesArr[] = "messages";
$nonAdminTablesArr[] = "arquivos";
$nonAdminTablesArr[] = "Selec_tec";
$nonAdminTablesArr[] = "Sd_ant";
$nonAdminTablesArr[] = "Seleciona_drae_novo";
...
$wGroupTableName = $ug_connection->addTableWrappers( "pedidosuggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "pedidosugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "pedidosugrights" );
