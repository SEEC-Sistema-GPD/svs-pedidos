...
$globalSettings["ProjectLogo"]["Portuguese(Brazil)"] = "SISPEDIDOS";
...
$styleOverrides["pedidos_view_list"] = array(
	"theme" => "cerulean",
	"size" => "small",
	"path" => "styles\\bootstrap\\custom\\pedidos_view_list",
);
...
$globalSettings["usersDatasourceTable"] = "pedidos_usuarios";


$globalSettings["jwtSecret"] = "XjaSE9UwDcit5MCWyPPu";
...
$projectBuildKey = "2536_1741785415";
...
$tableCaptions["Portuguese(Brazil)"]["np"] = "Np";
$tableCaptions["Portuguese(Brazil)"]["pedidos"] = "Pedidos";
$tableCaptions["Portuguese(Brazil)"]["cad_prod"] = "Cad Prod";
$tableCaptions["Portuguese(Brazil)"]["fornecedores"] = "Fornecedores";
$tableCaptions["Portuguese(Brazil)"]["escolas"] = "Escolas";
$tableCaptions["Portuguese(Brazil)"]["exercicios"] = "Exercicios";
$tableCaptions["Portuguese(Brazil)"]["status"] = "Status";
$tableCaptions["Portuguese(Brazil)"]["itens_view"] = "Itens View";
$tableCaptions["Portuguese(Brazil)"]["pedidos_usuarios"] = "Pedidos Usuarios";
...
$tableCaptions["Portuguese(Brazil)"]["un_med"] = "Un Med";
$tableCaptions["Portuguese(Brazil)"]["pedidos_view"] = "Pedidos";
$tableCaptions["Portuguese(Brazil)"]["cidades"] = "Cidades";
$tableCaptions["Portuguese(Brazil)"]["draes"] = "Draes";
$tableCaptions["Portuguese(Brazil)"]["tecnico"] = "Tecnico";
$tableCaptions["Portuguese(Brazil)"]["bairros"] = "Bairros";
$tableCaptions["Portuguese(Brazil)"]["alternativa"] = "Alternativa";
$tableCaptions["Portuguese(Brazil)"]["itens"] = "Itens";
$tableCaptions["Portuguese(Brazil)"]["fornecedores_view"] = "Fornecedores View";
$tableCaptions["Portuguese(Brazil)"]["NP_escola"] = "NP";
$tableCaptions["Portuguese(Brazil)"]["Pedidos_escola"] = "Pedidos";
$tableCaptions["Portuguese(Brazil)"]["itens_escola"] = "Itens Escola";
$tableCaptions["Portuguese(Brazil)"]["funcao"] = "Funcao";
$tableCaptions["Portuguese(Brazil)"]["direcs"] = "Direcs";
$tableCaptions["Portuguese(Brazil)"]["Relat_rio_Sint_tico_de_Escolas"] = "Relação de Escolas";
$tableCaptions["Portuguese(Brazil)"]["Relat_rio_Anal_tico_de_Escolas"] = "Relatório Analítico de Escolas";
$tableCaptions["Portuguese(Brazil)"]["pedidos3_noti"] = "Pedidos3 Noti";
$tableCaptions["Portuguese(Brazil)"]["Consulta_G_neros"] = "Consulta Gêneros";
$tableCaptions["Portuguese(Brazil)"]["messages"] = "Messages";
$tableCaptions["Portuguese(Brazil)"]["arquivos"] = "Porta-Arquivos";
$tableCaptions["Portuguese(Brazil)"]["Selec_tec"] = "Selec Tec";
$tableCaptions["Portuguese(Brazil)"]["Sd_ant"] = "Pesquisa saldo anterior.";
$tableCaptions["Portuguese(Brazil)"]["Seleciona_drae_novo"] = "Seleciona Drae Novo";
...
//mostrar as mensagens no topo da pagina dependedo do tipo (list, addd ). veja cadastro de mensagens!
...
//colocando o servidor para são paulo brazil

$now = date('d-m-Y H:i:s');
$fecha = new DateTime($now, new DateTimeZone('America/Fortaleza')); 
$timezone = $fecha->format('P');  // "+01:00" para Brasil
// MYSQL ---------------------------------------------------------------
DB::Exec("SET time_zone = '$timezone'"); // 
// PHP  ----------------------------------------------------------------
date_default_timezone_set('America/Fortaleza'); // Brasil
