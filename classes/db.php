...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "pedidos_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "alternativa", "varname" => "pedidos_at_localhost__alternativa", "altvarname" => "alternativa", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "arquivos", "varname" => "pedidos_at_localhost__arquivos", "altvarname" => "arquivos", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "bairros", "varname" => "pedidos_at_localhost__bairros", "altvarname" => "bairros", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "cad_prod", "varname" => "pedidos_at_localhost__cad_prod", "altvarname" => "cad_prod", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "cidades", "varname" => "pedidos_at_localhost__cidades", "altvarname" => "cidades", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "direcs", "varname" => "pedidos_at_localhost__direcs", "altvarname" => "direcs", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "draes", "varname" => "pedidos_at_localhost__draes", "altvarname" => "draes", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "escolas", "varname" => "pedidos_at_localhost__escolas", "altvarname" => "escolas", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "exercicios", "varname" => "pedidos_at_localhost__exercicios", "altvarname" => "exercicios", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "fornecedores", "varname" => "pedidos_at_localhost__fornecedores", "altvarname" => "fornecedores", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "funcao", "varname" => "pedidos_at_localhost__funcao", "altvarname" => "funcao", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "itens", "varname" => "pedidos_at_localhost__itens", "altvarname" => "itens", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "messages", "varname" => "pedidos_at_localhost__messages", "altvarname" => "messages", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "np", "varname" => "pedidos_at_localhost__np", "altvarname" => "np", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "pedidos", "varname" => "pedidos_at_localhost__pedidos", "altvarname" => "pedidos", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "pedidos3_noti", "varname" => "pedidos_at_localhost__pedidos3_noti", "altvarname" => "pedidos3_noti", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "pedidos_settings", "varname" => "pedidos_at_localhost__pedidos_settings", "altvarname" => "pedidos_settings", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "pedidos_usuarios", "varname" => "pedidos_at_localhost__pedidos_usuarios", "altvarname" => "pedidos_usuarios", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "pedidosuggroups", "varname" => "pedidos_at_localhost__pedidosuggroups", "altvarname" => "pedidosuggroups", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "pedidosugmembers", "varname" => "pedidos_at_localhost__pedidosugmembers", "altvarname" => "pedidosugmembers", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "pedidosugrights", "varname" => "pedidos_at_localhost__pedidosugrights", "altvarname" => "pedidosugrights", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "status", "varname" => "pedidos_at_localhost__status", "altvarname" => "status", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "tecnico", "varname" => "pedidos_at_localhost__tecnico", "altvarname" => "tecnico", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
			$dalTables[$conn->connId][] = array("name" => "un_med", "varname" => "pedidos_at_localhost__un_med", "altvarname" => "un_med", "connId" => "pedidos_at_localhost", "schema" => "", "connName" => "pedidos at localhost");
		}
	}
