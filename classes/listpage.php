...
class ListPage extends RunnerPage
{
	...
	{
		if( postvalue("pageType") == "register" && postvalue("table") == "pedidos_usuarios" )
			return new ProjectSettings( "pedidos_usuarios", PAGE_REGISTER, "", GLOBAL_PAGES);
