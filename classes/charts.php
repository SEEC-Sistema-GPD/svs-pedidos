...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("np" == $this->chrt_array['tables'][0])
			return true;
		if("pedidos" == $this->chrt_array['tables'][0])
			return true;
		if("cad_prod" == $this->chrt_array['tables'][0])
			return true;
		if("fornecedores" == $this->chrt_array['tables'][0])
			return true;
		if("escolas" == $this->chrt_array['tables'][0])
			return true;
		if("exercicios" == $this->chrt_array['tables'][0])
			return true;
		if("status" == $this->chrt_array['tables'][0])
			return true;
		if("itens" == $this->chrt_array['tables'][0])
			return true;
		if("pedidos_usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("pedidosugrights" == $this->chrt_array['tables'][0])
			return true;
		if("pedidosugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("pedidos_usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("un_med" == $this->chrt_array['tables'][0])
			return true;
		if("pedidos" == $this->chrt_array['tables'][0])
			return true;
		if("cidades" == $this->chrt_array['tables'][0])
			return true;
		if("draes" == $this->chrt_array['tables'][0])
			return true;
		if("tecnico" == $this->chrt_array['tables'][0])
			return true;
		if("bairros" == $this->chrt_array['tables'][0])
			return true;
		if("alternativa" == $this->chrt_array['tables'][0])
			return true;
		if("itens" == $this->chrt_array['tables'][0])
			return true;
		if("fornecedores" == $this->chrt_array['tables'][0])
		...
		if("itens" == $this->chrt_array['tables'][0])
			return true;
		if("funcao" == $this->chrt_array['tables'][0])
			return true;
		if("direcs" == $this->chrt_array['tables'][0])
			return true;
		if("escolas" == $this->chrt_array['tables'][0])
			return true;
		if("escolas" == $this->chrt_array['tables'][0])
			return true;
		if("pedidos3_noti" == $this->chrt_array['tables'][0])
			return true;
		if("cad_prod" == $this->chrt_array['tables'][0])
			return true;
		if("messages" == $this->chrt_array['tables'][0])
			return true;
		if("arquivos" == $this->chrt_array['tables'][0])
			return true;
		if("pedidos_usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("np" == $this->chrt_array['tables'][0])
