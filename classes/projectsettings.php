...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("pedidos_usuarios", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "np" ] = array( "url" => "np", "type" => 0 );
	$projectEntitiesReverse[ "np" ] = "np";
	$projectEntities[ "pedidos" ] = array( "url" => "pedidos", "type" => 0 );
	$projectEntitiesReverse[ "pedidos" ] = "pedidos";
	$projectEntities[ "cad_prod" ] = array( "url" => "cad_prod", "type" => 0 );
	$projectEntitiesReverse[ "cad_prod" ] = "cad_prod";
	$projectEntities[ "fornecedores" ] = array( "url" => "fornecedores", "type" => 0 );
	$projectEntitiesReverse[ "fornecedores" ] = "fornecedores";
	$projectEntities[ "escolas" ] = array( "url" => "escolas", "type" => 0 );
	$projectEntitiesReverse[ "escolas" ] = "escolas";
	$projectEntities[ "exercicios" ] = array( "url" => "exercicios", "type" => 0 );
	$projectEntitiesReverse[ "exercicios" ] = "exercicios";
	$projectEntities[ "status" ] = array( "url" => "status", "type" => 0 );
	$projectEntitiesReverse[ "status" ] = "status";
	$projectEntities[ "itens_view" ] = array( "url" => "itens_view", "type" => 1 );
	$projectEntitiesReverse[ "itens_view" ] = "itens_view";
	$projectEntities[ "pedidos_usuarios" ] = array( "url" => "pedidos_usuarios", "type" => 0 );
	$projectEntitiesReverse[ "pedidos_usuarios" ] = "pedidos_usuarios";
	...
	$projectEntities[ "un_med" ] = array( "url" => "un_med", "type" => 0 );
	$projectEntitiesReverse[ "un_med" ] = "un_med";
	$projectEntities[ "pedidos_view" ] = array( "url" => "pedidos_view", "type" => 1 );
	$projectEntitiesReverse[ "pedidos_view" ] = "pedidos_view";
	$projectEntities[ "cidades" ] = array( "url" => "cidades", "type" => 0 );
	$projectEntitiesReverse[ "cidades" ] = "cidades";
	$projectEntities[ "draes" ] = array( "url" => "draes", "type" => 0 );
	$projectEntitiesReverse[ "draes" ] = "draes";
	$projectEntities[ "tecnico" ] = array( "url" => "tecnico", "type" => 0 );
	$projectEntitiesReverse[ "tecnico" ] = "tecnico";
	$projectEntities[ "bairros" ] = array( "url" => "bairros", "type" => 0 );
	$projectEntitiesReverse[ "bairros" ] = "bairros";
	$projectEntities[ "alternativa" ] = array( "url" => "alternativa", "type" => 0 );
	$projectEntitiesReverse[ "alternativa" ] = "alternativa";
	$projectEntities[ "itens" ] = array( "url" => "itens", "type" => 0 );
	$projectEntitiesReverse[ "itens" ] = "itens";
	$projectEntities[ "fornecedores_view" ] = array( "url" => "fornecedores_view", "type" => 1 );
	$projectEntitiesReverse[ "fornecedores_view" ] = "fornecedores_view";
	$projectEntities[ "NP_escola" ] = array( "url" => "np_escola", "type" => 1 );
	$projectEntitiesReverse[ "np_escola" ] = "NP_escola";
	$projectEntities[ "Pedidos_escola" ] = array( "url" => "pedidos_escola", "type" => 1 );
	$projectEntitiesReverse[ "pedidos_escola" ] = "Pedidos_escola";
	$projectEntities[ "itens_escola" ] = array( "url" => "itens_escola", "type" => 1 );
	$projectEntitiesReverse[ "itens_escola" ] = "itens_escola";
	$projectEntities[ "funcao" ] = array( "url" => "funcao1", "type" => 0 );
	$projectEntitiesReverse[ "funcao1" ] = "funcao";
	$projectEntities[ "direcs" ] = array( "url" => "direcs", "type" => 0 );
	$projectEntitiesReverse[ "direcs" ] = "direcs";
	$projectEntities[ "Relatório Sintético de Escolas" ] = array( "url" => "relat_rio_sint_tico_de_escolas", "type" => 2 );
	$projectEntitiesReverse[ "relat_rio_sint_tico_de_escolas" ] = "Relatório Sintético de Escolas";
	$projectEntities[ "Relatório Analítico de Escolas" ] = array( "url" => "relat_rio_anal_tico_de_escolas", "type" => 2 );
	$projectEntitiesReverse[ "relat_rio_anal_tico_de_escolas" ] = "Relatório Analítico de Escolas";
	$projectEntities[ "pedidos3_noti" ] = array( "url" => "pedidos3_noti", "type" => 0 );
	$projectEntitiesReverse[ "pedidos3_noti" ] = "pedidos3_noti";
	$projectEntities[ "Consulta Gêneros" ] = array( "url" => "consulta_g_neros", "type" => 1 );
	$projectEntitiesReverse[ "consulta_g_neros" ] = "Consulta Gêneros";
	$projectEntities[ "messages" ] = array( "url" => "messages", "type" => 0 );
	$projectEntitiesReverse[ "messages" ] = "messages";
	$projectEntities[ "arquivos" ] = array( "url" => "arquivos", "type" => 0 );
	$projectEntitiesReverse[ "arquivos" ] = "arquivos";
	$projectEntities[ "Selec_tec" ] = array( "url" => "selec_tec", "type" => 1 );
	$projectEntitiesReverse[ "selec_tec" ] = "Selec_tec";
	$projectEntities[ "Sd_ant" ] = array( "url" => "sd_ant", "type" => 1 );
	$projectEntitiesReverse[ "sd_ant" ] = "Sd_ant";
	$projectEntities[ "Seleciona_drae_novo" ] = array( "url" => "seleciona_drae_novo", "type" => 1 );
	$projectEntitiesReverse[ "seleciona_drae_novo" ] = "Seleciona_drae_novo";
}
