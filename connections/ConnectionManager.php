...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "pedidos_at_localhost";
		$data["connName"] = "pedidos at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;usuariopedidos;r#NjuB6T6Qmfm8sw;;pedidos;;1"; //currently unused

		$this->_connectionsIdByName["pedidos at localhost"] = "pedidos_at_localhost";

		$data["connInfo"] = array();
		$data["ODBCUID"] = "usuariopedidos";
		$data["ODBCPWD"] = "r#NjuB6T6Qmfm8sw";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][1] = "usuariopedidos";
		$data["connInfo"][2] = "r#NjuB6T6Qmfm8sw";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "pedidos";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=usuariopedidos;Pwd=r#NjuB6T6Qmfm8sw;Database=pedidos;OPTION=3";
		// encription set
		...
		$connectionsData["pedidos_at_localhost"] = $data;
